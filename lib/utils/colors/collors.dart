...
class Collors {
  static Color backgroundPage = const Color.fromRGBO(244, 245, 248, 1);
  ...
  static Color orange = const Color.fromRGBO(237, 125, 49, 1);
  static Color yellow = const Color.fromRGBO(255, 192, 0, 1);
  static Color green = const Color.fromRGBO(153, 204, 51, 1);
  static Color blueBold = const Color.fromRGBO(0, 112, 192, 1);
  static Color purple = const Color.fromRGBO(112, 48, 160, 1);
}
